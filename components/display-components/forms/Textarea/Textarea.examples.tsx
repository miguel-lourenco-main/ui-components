...
export const SmallPreview = () => (
  <div className="w-full max-w-[180px]">
    <TextareaComponent placeholder="Type here..." rows={2} />
  </div>
)

export const MediumPreview = () => (
  <div className="w-full max-w-[240px]">
    <TextareaComponent label="Message" placeholder="Type here..." />
  </div>
)
...
export const textareaVariants = [
  ...
  },
  {
    ...
    preview: (
      <div className="w-full max-w-md">
        <TextareaComponent label="Bio" placeholder="Tell us about yourself" helperText="Minimum 10 characters" />
      </div>
    ),
    code: `<Textarea label="Bio" placeholder="Tell us about yourself" helperText="Minimum 10 characters" />`,
  },
  {
    id: 'error',
    name: 'Error State',
    description: 'Shows error styling and message',
    theme: 'modern',
    preview: (
      <div className="w-full max-w-md">
        <TextareaComponent label="Email" placeholder="Email" error="Please enter a valid email" />
      </div>
    ),
    code: `<Textarea label="Email" placeholder="Email" error="Please enter a valid email" />`,
  },
  {
    id: 'disabled',
    name: 'Disabled',
    ...
    preview: (
      <div className="w-full max-w-md">
        <TextareaComponent label="Comments" value="This textarea is disabled" disabled />
      </div>
    ),
    code: `<Textarea label="Comments" value="This textarea is disabled" disabled />`,
  },
];

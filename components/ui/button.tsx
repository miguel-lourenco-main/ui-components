...
export const buttonStyles = {
  ...
  variants: {
    ...
    background: 'bg-background text-foreground hover:text-foreground/90',
    foreground: 'bg-foreground text-background hover:bg-foreground/90',
    light_foreground: 'bg-foreground/60 text-background hover:bg-foreground/30',
    transparent: 'bg-transparent text-foreground hover:bg-foreground/90',
  },
  sizes: {
